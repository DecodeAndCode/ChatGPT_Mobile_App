...
import 'package:chatgpt_mobile_app/feature_box.dart';
import 'package:chatgpt_mobile_app/pallete.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: BounceInDown(child: const Text('chatGPT Mobile App')),
        centerTitle: true,
      ),
